...
const baseMonsters = [
  {
    ...
    image: require("../../assets/images/monsterimgs/dark_magician.png"),
  },
  {
    name: "Blauäugiger Drache",
    effect: "Gib einen Schluck ab, wenn du trinken musst.",
    image: require("../../assets/images/monsterimgs/blue_eyes.png"),
  },
  {
    name: "Kuriboh",
    effect: "Einmal darfst du komplett aussetzen.",
    image: require("../../assets/images/monsterimgs/kuriboh.png"),
  },
  {
